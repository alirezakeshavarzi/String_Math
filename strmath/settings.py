"""
Django settings for strmath project.
...
SECRET_KEY = 'django-insecure-ljqd=2#dmgoeiomtc1m)&uidbwx(8uz(pm@#(8%(b5pv^r@gc9'
...
WSGI_APPLICATION = 'strmath.wsgi.application'
